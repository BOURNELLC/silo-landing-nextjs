...
function Signup() {
    ...
    return (
        <div className='bg-[#060C18] min-h-screen text-white py-20'>
            <div className="flex flex-col lg:flex-row gap-10 max-w-7xl mx-auto px-7 2xl:px-0">
                ...
                <div className='w-full lg:w-[55%] text-center lg:text-left bg-white bg-opacity-5 p-10 rounded-lg'>
                        ...
                        <form className='mt-5'>
                            <div className='flex flex-col gap-5'>
                                ...
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <input type="email" name='email' id='email' className='bg-[#060C18] border border-gray-300 rounded-md px-5 py-3' />
                                </div>
                                <div className='flex flex-col gap-2'>
